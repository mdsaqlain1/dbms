...
const Electricty = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (emptyFields.length > 0) {
      ...
      setSubmit(true);
      axios.post("http://localhost:3000/api/electricitydata/", data)
      axios.post("http://localhost:3000/api/electric/", valuesOf)
    }
  };
          ...
          <div className="modal" style={{paddingLeft:"170px", marginTop:"20px", overflowX:"hidden"}}>
            <div className="modal-container">
              <div className="modal-left">
                <h1 className="modal-title">Track Electricity!</h1>
                <p className="modal-desc">
                  Please donot waste electricity
                </p>
